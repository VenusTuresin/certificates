...
- **Introduction to Programming (Kaggle)**
  ...
  1. Arithmetic and Variables – performing calculations, defining, and modifying variables.  
  2. Functions – writing reusable code to organize programs and avoid redundancy.  
  3. Data Types – understanding integers, floats, booleans, and strings.  
  4. Conditions and Conditional Statements – controlling program flow with if/else logic.  
